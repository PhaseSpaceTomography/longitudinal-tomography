...
class TestPhysics(unittest.TestCase):
    ...
    def test_phase_low(self):
        ...
        phase = 0.0023213
        bunch_phaselength = 100
        self.assertAlmostEqual(phase_low(phase, self.par, bunch_phaselength, rf_turn=0),
                               123831.46073450413,
    ...
    def test_dphase_low(self):
        ...
        phase = 0.0023213
        bunch_phaselength = 100
        self.assertAlmostEqual(dphase_low(phase, self.par, bunch_phaselength),
                               4018.5009484603393,
                               msg='Error in calculation of '
