...
def kick_drift_up_whole(dphi: CPArray, denergy: CPArray, xp: CPArray, yp: CPArray, drift_coef: CPArray,
                        rfv1: CPArray, rfv2: CPArray, phi0: CPArray, phi12: CPArray, h_ratio: float,
                        n_particles: int, acc_kick: CPArray, turn: int, nturns: int, dturns: int, profile: int) -> None:
...
def kick_drift_down_whole(dphi: CPArray, denergy: CPArray, xp: CPArray, yp: CPArray, drift_coef: CPArray,
                        rfv1: CPArray, rfv2: CPArray, phi0: CPArray, phi12: CPArray, h_ratio: float,
                        n_particles: int, acc_kick: CPArray, turn: int, dturns: int, profile: int) -> None:
    kick_drift_down_turns(args=(dphi, denergy, xp, yp, drift_coef, rfv1, rfv2,
                            phi0, phi12, h_ratio, n_particles, acc_kick,
                            turn, dturns, profile),
                        block=block_size, grid=(int(n_particles / block_size[0] + 1), 1, 1))

def kick_and_drift_cuda(xp: CPArray, yp: CPArray,
